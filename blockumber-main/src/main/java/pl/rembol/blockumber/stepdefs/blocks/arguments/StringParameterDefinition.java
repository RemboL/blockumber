...
public class StringParameterDefinition implements BlockDefinition, WithOneLine, WithOutput {
    public static final StringParameterDefinition INSTANCE = new StringParameterDefinition();
